...
class cedclean extends Timber\Site {
	...
	public function __construct() {
		...
		public function register_post_types() {
			require get_template_directory() . '/home_post/custom-post-home.php';
...
new cedclean();
	...
	* style theme
	*/
	function cedclean_style()  {
		wp_enqueue_style( 'styles', get_stylesheet_directory_uri() . cedclean_get_hash( 'styles.css' ) );
	}
	add_action( 'wp_enqueue_scripts', 'cedclean_style' );

	
	/*
	* scripts theme
	*/
	function cedclean_scripts()  {
		// wp_enqueue_script('vendors', get_template_directory_uri() . cedclean_get_hash('vendors.js'), array(), '', true);
		wp_enqueue_script('app', get_template_directory_uri() . cedclean_get_hash('app.js'), array(), '', true);
	}
	add_action( 'wp_footer', 'cedclean_scripts' );


	/*
	* hash webpack 
	*/
	function cedclean_get_hash( $file ) {
	...
	function menu_homePage(){
			add_menu_page(
				...
				'Page Accueil',          
				'edit_posts',            
				'home_post/custom-post-home.php',
				'',                   
